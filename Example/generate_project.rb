...
tests.add_file_references(%w[MediaPickerTests.swift PickerCancelNavigationTests.swift LegacyCropEditorTests.swift ObjCBridgeTests.m].map { |name| test_group.new_file(name) })
